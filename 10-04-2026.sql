...
CREATE TABLE IF NOT EXISTS "Invoice" (
	...
	"orderMode" TEXT NOT NULL DEFAULT 'INDIVIDUAL',
...
CREATE TABLE IF NOT EXISTS "SubscriptionPlan" (
	...
	"redemptionMode" UNKNOWN NOT NULL DEFAULT 'MULTI_USE',
	"validityDays" INTEGER NOT NULL,
	"kgLimit" NUMERIC(10,2) NULL DEFAULT NULL,
	"minKgPerPickup" NUMERIC(10,2) NULL DEFAULT NULL,
	"applicableServiceTypes" UNKNOWN NULL DEFAULT NULL,
	"active" BOOLEAN NOT NULL DEFAULT true,
	"createdAt" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	"updatedAt" TIMESTAMP NOT NULL,
	"variant" UNKNOWN NOT NULL,
